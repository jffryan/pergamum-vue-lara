  ...
  <div>
    ...
    <div v-if="statistics" class="bg-zinc-800 text-white">
      <div class="grid grid-cols-12 gap-4 p-4">
        ...
        <div class="p-4 bg-slate-600 col-span-4">
          <span class="block text-7xl font-bold mb-4">{{ totalBooks }}</span>
        ...
        <div class="p-4 bg-zinc-700 col-span-4">
          ...
          >
          <p class="ml-8 text-lg">Percentage of Collection Completed</p>
        </div>
        ...
        <div class="p-4 bg-zinc-700 col-span-4">
          <h3>
            <router-link :to="{ name: 'backlog.index' }" class="hover:underline"
          ...
          <ul class="list-disc ml-4">
            <li v-for="item in topBacklogItems" :key="item.id">
              <router-link
                :to="{ name: 'books.show', params: { slug: item.book.slug } }"
