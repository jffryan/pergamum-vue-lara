...
const getOneList = async (listId) =>
    makeRequest("get", buildUrl("lists", listId));

const createList = async (name) =>
    makeRequest("post", buildUrl("lists"), { name });

const updateList = async (listId, name) =>
    makeRequest("patch", buildUrl("lists", listId), { name });

const deleteList = async (listId) =>
    makeRequest("delete", buildUrl("lists", listId));
...
const addItemToList = async (listId, versionId) =>
    makeRequest("post", `/api/lists/${listId}/items`, {
